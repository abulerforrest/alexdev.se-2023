export type ICode<C extends string, L extends string> = {
  code: C;
  language: L;
};
...
export const code: ICode<string, string>[] = [
  { code: c, language: "tsx" },
  { code: c1, language: "golang" },
  { code: c2, language: "js" },
  { code: c3, language: "tsx" },
];

    ...
    <div className='flex justify-center w-full'>
      <div className='lg:pt-20 pt-10 mx-8 lg:mx-20 md:mx-20 sm:mx-14 lg:px-32 font-eurostile text-retro-black dark:text-bone-white text-about-text-sm sm:text-about-text-sm md:text-about-text-md xl:text-about-text-xl'>
        <p className='mb-7'>
          ...
          music, I've had an exciting journey to becoming a full-time developer.
          Starting at just 14 years old, I dove into website projects,
          programming, and design, and ran several music projects over the
          years.
        </p>
        <p className='mb-7'>
